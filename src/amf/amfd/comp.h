...
class AVD_COMP_TYPE {
 public:
  ...
  std::string saAmfCtDefCmdEnv{};
  SaTimeT saAmfCtDefClcCliTimeout{};
  SaTimeT saAmfCtDefCallbackTimeout{};
  std::string saAmfCtRelPathInstantiateCmd{};
  std::string saAmfCtDefInstantiateCmdArgv{};
  SaUint32T saAmfCtDefInstantiationLevel{};
  std::string saAmfCtRelPathTerminateCmd{};
  std::string saAmfCtDefTerminateCmdArgv{};
  std::string saAmfCtRelPathCleanupCmd{};
  std::string saAmfCtDefCleanupCmdArgv{};
  std::string saAmfCtRelPathAmStartCmd{};
  std::string saAmfCtDefAmStartCmdArgv{};
  std::string saAmfCtRelPathAmStopCmd{};
  std::string saAmfCtDefAmStopCmdArgv{};
